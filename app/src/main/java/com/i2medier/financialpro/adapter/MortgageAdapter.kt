...
class MortgageAdapter(
    private val context: Context,
    var monthModels: ArrayList<MonthModel>,
    private var isMonthly: Boolean
) : RecyclerView.Adapter<MortgageAdapter.ViewHolder>() {

    fun setList(arrayList: ArrayList<MonthModel>, isMonthly: Boolean) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_mortgage, parent, false)
        return ViewHolder(view)
    }

    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val model = monthModels[position]
        holder.txtMonth.text = if (isMonthly) model.getDate() else model.year.toString()
        ...
        holder.txtTaxInsPMI.text = Utils.decimalFormat.format(model.TaxInsPMI)
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val txtTaxInsPMI: TextView = itemView.findViewById(R.id.txtTaxInsPMI)
