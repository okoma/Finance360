...
class CompoundAdapter(
...
) : RecyclerView.Adapter<CompoundAdapter.ViewHolder>() {
    ...
    fun getMonthModels(): ArrayList<MonthModel> = monthModels

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_compound_interest, parent, false)
