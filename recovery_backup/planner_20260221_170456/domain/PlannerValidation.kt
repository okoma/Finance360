...
fun validateGoalInput(title: String, targetAmount: Double?, description: String?): ValidationResult {
    ...
    return when {
        ...
        wordCount(normalizedTitle) > GOAL_TITLE_MAX_WORDS ->
            ValidationResult(false, "Goal title max $GOAL_TITLE_MAX_WORDS words")
        normalizedTitle.length > GOAL_TITLE_MAX_CHARS ->
            ValidationResult(false, "Goal title max $GOAL_TITLE_MAX_CHARS characters")
